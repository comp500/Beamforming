...
import link.infra.superposition.blocks.PrismBlock;
import link.infra.superposition.blocks.PrismBlockEntity;
...
public class Superposition implements ModInitializer {
	public static final Logger LOGGER = LoggerFactory.getLogger("Superposition");
